...
Notice that, although the number of trees is preserved, the basal area is not. However, if the width of the smoothing window is not very large, the basal area computed with the discrete values and that obtained with the smoothed distribution are not very different.
